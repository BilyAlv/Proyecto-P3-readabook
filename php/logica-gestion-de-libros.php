<?php
/**
 * Lógica para la gestión de libros - Versión Mejorada
 * 
 * Maneja todas las operaciones CRUD para libros con validaciones robustas
...
// No cerramos la conexión aquí para que esté disponible en la vista